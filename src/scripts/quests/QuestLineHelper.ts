...
class QuestLineHelper {
    ...
    public static createGiratinaOriginQuestLine() {
        const giratinaOriginQuestLine = new QuestLine('Zero\'s Ambition', 'Help Zero find an entrance to the Distorsion World', new MultiRequirement([new ObtainedPokemonRequirement(pokemonMap['Giratina (Altered)']), new GymBadgeRequirement(BadgeEnums.Elite_SinnohChampion)]) , GameConstants.BulletinBoards.Sinnoh);
